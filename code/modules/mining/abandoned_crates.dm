...
/obj/structure/closet/crate/secure/loot/New()
	...
	switch(loot)
		if(1 to 5) //5% chance
			...
			new /obj/item/weapon/reagent_containers/food/snacks/grown/cannabis/white(src)
			new /obj/item/weapon/reagent_containers/food/snacks/grown/cannabis/death(src)
			new /obj/item/weapon/reagent_containers/food/snacks/grown/cannabis/ultimate(src)
		...
		if(31 to 35)
			for(var/i in 1 to 3)
				new /obj/item/weapon/reagent_containers/food/snacks/grown/cherry_bomb(src)
		if(36 to 40)
		...
		if(61 to 62)
			new /obj/item/weapon/gun/energy/e_gun/dragnet(src)
			for(var/i in 1 to 5)
		...
		if(75 to 76)
			new /obj/item/weapon/gun/magic/staff/healing(src)
		if(77 to 78)
		...
		if(94)
			...
			new /obj/item/stack/sheet/mineral/bananium(src)
		if(95)
		...
		if(99)
			...
			new /obj/item/weapon/plasma_fist_scroll(src)
		if(100)
