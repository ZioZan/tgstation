...
/obj/structure/closet/crate/secure/loot/New()
	...
	switch(loot)
		if(1 to 5) //5% chance
			...
			new /obj/item/reagent_containers/food/snacks/grown/cannabis/white(src)
			new /obj/item/reagent_containers/food/snacks/grown/cannabis/death(src)
			new /obj/item/reagent_containers/food/snacks/grown/cannabis/ultimate(src)
		...
		if(31 to 35)
			for(var/i in 1 to 3)
				new /obj/item/reagent_containers/food/snacks/grown/cherry_bomb(src)
		if(36 to 40)
		...
		if(57 to 58)
			...
			new /obj/item/storage/box/syndie_kit/imp_storage
		if(59 to 60)
		...
		if(61 to 62)
			new /obj/item/gun/energy/e_gun/dragnet(src)
			for(var/i in 1 to 5)
		...
		if(95)
			...
			new /obj/item/spellbook/oneuse/forcewall(src)
		if(96)
		...
		if(99)
			...
			new /obj/item/plasma_fist_scroll(src)
		if(100)
