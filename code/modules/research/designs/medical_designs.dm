...
/datum/design/bluespacesyringe
	...
	build_type = PROTOLATHE
	materials = list(MAT_GLASS = 4000, MAT_PLASMA = 200, MAT_DIAMOND = 200)
...
/datum/design/noreactsyringe
	...
	build_type = PROTOLATHE
	materials = list(MAT_GLASS = 4000, MAT_GOLD = 100)
...
/datum/design/piercesyringe
	...
	id = "piercesyringe"
	req_tech = list("materials" = 5, "combat" = 3, "engineering" = 4)
	build_type = PROTOLATHE
	materials = list(MAT_GLASS = 4000, MAT_DIAMOND = 500)
...
/datum/design/bluespacebodybag
	...
	req_tech = list("bluespace" = 2, "materials" = 6)
	build_type = PROTOLATHE
	materials = list(MAT_METAL = 3000, MAT_PLASMA = 200, MAT_DIAMOND = 500)
...
/datum/design/plasmarefiller
	...
	id = "plasmarefiller"
	req_tech = list("materials" = 2, "plasmatech" = 3)
	build_type = PROTOLATHE
...
/datum/design/cyberimp_medical_hud
	...
	materials = list(MAT_METAL = 200, MAT_GLASS = 200, MAT_SILVER = 500)
...
/datum/design/cyberimp_security_hud
	...
	id = "ci-sechud"
	req_tech = list("materials" = 5, "programming" = 4, "biotech" = 4, "combat" = 2)
	build_type = PROTOLATHE | MECHFAB
	construction_time = 50
	materials = list(MAT_METAL = 600, MAT_GLASS = 600, MAT_SILVER = 750)
...
/datum/design/cyberimp_xray
	...
	id = "ci-xray"
	req_tech = list("materials" = 7, "programming" = 5, "biotech" = 5, "magnets" = 5)
	build_type = PROTOLATHE | MECHFAB
	construction_time = 60
	materials = list(MAT_METAL = 600, MAT_GLASS = 600, MAT_SILVER = 600, MAT_GOLD = 600, MAT_PLASMA = 1000, MAT_URANIUM = 1000, MAT_DIAMOND = 1000)
...
/datum/design/cyberimp_thermals
	...
	build_type = PROTOLATHE | MECHFAB
	construction_time = 60
	materials = list(MAT_METAL = 600, MAT_GLASS = 600, MAT_SILVER = 600, MAT_GOLD = 600, MAT_PLASMA = 1000, MAT_DIAMOND = 1000)
...
/datum/design/cyberimp_nutriment_plus
	...
	id = "ci-nutrimentplus"
	req_tech = list("materials" = 6, "powerstorage" = 4, "biotech" = 5)
	build_type = PROTOLATHE | MECHFAB
	construction_time = 50
...
/datum/design/cyberimp_reviver
	...
	id = "ci-reviver"
	req_tech = list("materials" = 6, "programming" = 4, "biotech" = 6, "syndicate" = 4)
	build_type = PROTOLATHE | MECHFAB
	construction_time = 60
...
/datum/design/cyberimp_thrusters
	...
	id = "ci-thrusters"
	req_tech = list("materials" = 5, "biotech" = 5, "magnets" = 4, "engineering" = 5)
	build_type = PROTOLATHE | MECHFAB
...
/datum/design/implanter
	...
	id = "implanter"
	req_tech = list("materials" = 1, "biotech" = 2, "programming" = 3)
	build_type = PROTOLATHE
...
/datum/design/implant_adrenalin
	...
	build_type = PROTOLATHE
	materials = list(MAT_METAL = 1000, MAT_GLASS = 500, MAT_GOLD = 500, MAT_URANIUM = 100, MAT_DIAMOND = 200)
