...
/datum/design/BS_RPED
	...
	id = "bs_rped"
	req_tech = list("engineering" = 3, "materials" = 4, "programming" = 3, "bluespace" = 3)
	build_type = PROTOLATHE
	materials = list(MAT_METAL = 10000, MAT_GLASS = 5000, MAT_SILVER = 2500) //hardcore
...
/datum/design/bluespace_matter_bin
	...
	build_type = PROTOLATHE
	materials = list(MAT_METAL = 160, MAT_DIAMOND = 100)
